...
if (state.vy < 0) {
	...
	if (level_collision(_x0 + HEAD_OFFSET, _y0) > TILES_NONE) {
...
if (state.vy >= 0) {
	...
	if (
		level_collision(_x0 + LEFT_FOOT_OFFSET, _y1) > TILES_NONE ||
		level_collision(_x1 - RIHGT_FOOT_OFFSET, _y1) > TILES_NONE
	) {
